...
public class PropertyDeveloperResponse {
	...
	public PropertyDeveloperResponse() {
		// TODO Auto-generated constructor stub
	}
	public PropertyDeveloperResponse(int propertyDeveloperId, PropertyType propertyType,
			TransactionType transactionType, ConstructionStatus constructionStatus, int bhk, int bathroom, int balcony,
			FurnishedType furnishedType, Parking parking, int openParking, LocalDate possessionDate, long cost,
			int maintainceCharge, BrockrageCharge brockrageCharge, double builtUpArea, double carpetArea, double area,
			LandType landType, Facing facing, String propertyAddress, String reraId, String propertyDescription,
			String city, String propertyLocation, String state, byte[] video, byte[] photo) {
		super();
		this.propertyDeveloperId = propertyDeveloperId;
		this.propertyType = propertyType;
		this.transactionType = transactionType;

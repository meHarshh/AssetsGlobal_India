...
//	This form is used to add the leads to the db and send the mail to the official of the assets global
	...
	private void sendMail(ContactForm contactForm) throws MessagingException {
		...
		model.setTo(contactForm.getEmail());
		model.setText(htmlContent);
		model.setSubject("Regarding Assets global lead");
	...
	private ContactFormResponse mapToContactFormResponse(ContactForm contactForm) {
		...
		contactFormResponse.setContactId(contactForm.getContactId());
		contactFormResponse.setName(contactForm.getName());
		contactFormResponse.setMessage(contactForm.getMessage());
		contactFormResponse.setEmail(contactForm.getMessage());
		contactFormResponse.setMobileNumber(contactForm.getMobileNumber());
